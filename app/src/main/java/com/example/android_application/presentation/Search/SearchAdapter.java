...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.Holder> implements SearchContract.View{

    private Context context;
    private List<ItemData> list = new ArrayList<>();

    public SearchAdapter(Context context, List<ItemData> list) {
